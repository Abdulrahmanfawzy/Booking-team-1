...
export default function Hero() {
    return (
        <div>
            <section className={cn('relative', 'overflow-hidden', 'px-4', 'pb-20', 'md:pt-16', 'sm:px-6', 'lg:px-10')}>
                {/* decorative backdrop */}
                <div
                    aria-hidden
                    className={cn('pointer-events-none', 'absolute', 'left-1/2', 'top-1/2', 'h-[520px]', 'w-[520px]', '-translate-x-1/2', '-translate-y-1/2', 'rounded-full', 'border', 'border-slate-100', 'sm:h-[640px]', 'sm:w-[640px]')}
                />
                <div
                    aria-hidden
                    className={cn('pointer-events-none', 'absolute', 'left-1/2', 'top-1/2', 'h-[360px]', 'w-[360px]', '-translate-x-1/2', '-translate-y-1/2', 'rounded-full', 'border', 'border-slate-100', 'sm:h-[440px]', 'sm:w-[440px]')}
                />

                <div className={cn('relative', 'mx-auto', 'flex', 'max-w-2xl', 'flex-col', 'items-center', 'text-center')}>
                    <span className={cn('mb-5', 'inline-flex', 'items-center', 'gap-1.5', 'rounded-full', 'bg-blue-50', 'px-3', 'py-1', 'text-xs', 'font-medium', 'text-blue-600')}>
                        <Sparkles size={12} /> Upgrade your account
                    </span>

                    <h1 className={cn('font-serif', 'text-4xl', 'leading-tight', 'text-slate-900', 'sm:text-5xl')}>
                        Find and book top
                    </h1>

                    <p className={cn('mt-5', 'max-w-lg', 'text-sm', 'text-slate-500', 'sm:text-base')}>
                    ...
                    <div className={cn('mt-6', 'flex', 'items-center', 'gap-2', 'rounded-full', 'border', 'border-slate-100', 'bg-white', 'px-3', 'py-1.5', 'shadow-sm')}>
                        <div className={cn('flex', '-space-x-2.5')}>
                            {REVIEW_AVATARS.slice(0, 3).map((n) => (
                                <img
                                    ...
                                    alt=""
                                    className={cn('h-6', 'w-6', 'rounded-full', 'ring-2', 'ring-white')}
                                />
                            ))}
                        </div>
                        <span className={cn('text-xs', 'font-medium', 'text-slate-600')}>10k+ happy patients</span>
                    </div>
                ...
                <div className={cn('absolute', '-left-1', 'top-15', 'hidden', '-translate-y-1/2', '-rotate-18', 'items-center', 'gap-2', 'rounded-full', 'border', 'border-slate-100', 'bg-white', 'px-3', 'py-2', 'shadow-sm', 'md:flex', 'lg:left-16')}>
                    <span className={cn('flex', 'h-7', 'w-7', 'items-center', 'justify-center', 'rounded-full', 'bg-blue-600', 'text-white')}>
                        <MapPin size={14} />
                    </span>
                ...
                <div className={cn('absolute', 'bottom-6', 'right-6', 'hidden', 'rotate-12', 'items-center', 'gap-1.5', 'rounded-full', 'bg-white', 'px-3', 'py-1.5', 'text-xs', 'font-medium', 'italic', 'text-slate-600', 'shadow-sm', 'md:flex', 'lg:right-20')}>
                    <ArrowUpRight size={14} className={cn('-rotate-45', 'text-blue-600')} />
                    Book Now
                </div>
            </section>
        </div>
